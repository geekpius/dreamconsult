...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        /* $this->get('user/signin', 'Auth\LoginController@showLoginForm')->name('login');
        $this->post('user/login', 'Auth\LoginController@login');
        $this->post('user/logout', 'Auth\LoginController@logout')->name('logout'); */
        ...
        /* $this->get('user/password/reset', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('password.request');
        $this->post('user/password/email', 'Auth\ForgotPasswordController@sendResetLinkEmail')->name('password.email');
        $this->get('user/password/reset/{token}', 'Auth\ResetPasswordController@showResetForm')->name('password.reset');
        $this->post('user/password/reset', 'Auth\ResetPasswordController@reset'); */
    }
