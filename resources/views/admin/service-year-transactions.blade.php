<table id="example" class="table table-striped table-borderless">
    <thead>
        <tr><th colspan="9" class="text-primary"><strong>THIS YEAR SERVICE TRANSACTIONS - {{ \Carbon\Carbon::today()->year }}</strong></th></tr>
        <tr>
            <th>Rec#</th> 
            <th>Pay Date</th>                        
            <th>Service Name</th>  
...
var table = $('#example').DataTable( {
    ...
    buttons: [
            {
                extend: 'excelHtml5',
                title: 'YEARLY SERVICE TRANSACTIONS',
                exportOptions: {
            ...
            },
            {
                extend: 'pdfHtml5',
                title: 'YEARLY SERVICE TRANSACTIONS',
                messageTop: "THIS YEAR TRANSACTIONS - {{ \Carbon\Carbon::today()->year }}",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6, 7 ]
                }
            },
            {
                extend: 'print',
                title: 'YEARLY SERVICE TRANSACTIONS',
                messageTop: "THIS YEAR SERVICE TRANSACTIONS - {{ \Carbon\Carbon::today()->year }}",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6, 7 ]
                }
            },
