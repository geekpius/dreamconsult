<table id="example" class="table table-striped table-borderless">
    <thead>
        <tr><th colspan="9" class="text-primary"><strong>WEEKLY TRANSACTIONS - From {{ \Carbon\Carbon::now()->startOfWeek()->format('D d-M-Y') }} To {{ \Carbon\Carbon::now()->endOfWeek()->format('D d-M-Y') }}</strong></th></tr>
        <tr>
            <th>Rec#</th> 
            <th>Pay Date</th> 
            <th>Client ID</th>                     
    ...
    @php $total_paid += $pay->paid; $total_owe += $pay->owe; @endphp
        <tr class="records">
            ...
            <td>{{ \Carbon\Carbon::parse($pay->created_at)->format('d-M-Y - h:ia') }}</td>
