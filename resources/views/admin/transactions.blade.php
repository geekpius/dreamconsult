...
<div class="row pt-2 pb-2">
    <div class="col-sm-9">
        <h4 class="page-title">Perform this activities on transaction module</h4>
        <ol class="breadcrumb">
...
function getTodayTableContent(){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.today') }}",
        type: "GET",
        success: function(resp){
            $("#table_content").html(resp);
        },
...
function getWeekTableContent(){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.week') }}",
        type: "GET",
        success: function(resp){
            $("#table_content").html(resp);
        },
...
function getSingleTableContent(data){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.single') }}",
        type: "POST",
        data: data,
        success: function(resp){
            $("#table_content").html(resp);
...
function getRangeTableContent(data){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.range') }}",
        type: "POST",
        data: data,
        success: function(resp){
            $("#table_content").html(resp);
...
function getMonthTableContent(){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.month') }}",
        type: "GET",
        success: function(resp){
            $("#table_content").html(resp);
        },
...
function getYearTableContent(){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.transactions.year') }}",
        type: "GET",
        success: function(resp){
            $("#table_content").html(resp);
        },
