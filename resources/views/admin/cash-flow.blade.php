...
<div class="row pt-2 pb-2">
    <div class="col-sm-9">
        <h4 class="page-title">Perform this activities on cash flow module</h4>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            ...
            <button type="button" data-toggle="modal" data-target="#RangeModal" data-backdrop="static" class="btn btn-primary px-4 btn-sm ml-1 btn_range"><i class="fa fa-calendar-o"></i> FILTER DATES</button>
       </div>
        <div class="card-body">
...
function getRangeTableContent(data){
    $("#table_content").html('<div class="text-center"><i class="fa fa-spin fa-spinner text-primary fa-5x"></i></div>');
    $.ajax({
        url: "{{ route('admin.cash.flow.range') }}",
        type: "POST",
        data: data,
        success: function(resp){
            $("#table_content").html(resp);
