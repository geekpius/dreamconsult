<table id="example" class="table table-striped table-borderless">
    <thead>
        <tr><th colspan="9" class="text-primary"><strong>MONTHLY SERVICE TRANSACTIONS AS AT {{ \Carbon\Carbon::today()->format('F') }}</strong></th></tr>
        <tr>
            <th>Rec#</th> 
            <th>Pay Date</th>                        
            <th>Service Name</th>  
...
var table = $('#example').DataTable( {
    ...
    buttons: [
            {
                extend: 'excelHtml5',
                title: 'MONTHLY SERVICE TRANSACTIONS',
                exportOptions: {
            ...
            },
            {
                extend: 'print',
                title: 'MONTHLY SERVICE TRANSACTIONS',
                messageTop: "MONTHLY SERVICE TRANSACTIONS AS AT {{ \Carbon\Carbon::today()->format('F') }}",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6, 7 ]
                }
            },
