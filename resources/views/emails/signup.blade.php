...
<meta property="og:title" content="Dreams Consult" />
</head>
<!--[if mso]>
  <body class="mso">
<![endif]-->
    ...
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        ...
        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
          <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #80bf2e;" href="https://dreamsconsult.com/"><img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;display: block;height: auto;width: 100%;max-width: 46px;" alt="Logo" width="46" src="{{ asset('assets/images/logos/main-logo.png') }}" /></a>
        </div>
      
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <h1 class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 20px;line-height: 28px;text-align: center;" lang="x-size-24"><span style="color:#e67409"><strong>USER SIGNED UP ACKNOWLEDGEMENT</strong></span></h1><p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;" lang="x-size-14"><br />
        <span style="color:#000000">Hi {{ current(explode(' ',$data['name'])) }},</span></p><p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="color:#000000">You have been signed up on Dreams Consult system. Your password is {{ $data['password'] }}</span></p><p class="size-14" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 14px;line-height: 21px;" lang="x-size-14"><span style="color:#000000"><a href="https://www.office.dreamsconsult.com/admin/signin" target="_blank">Sign in</a> and change default password.</span></p>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
      <p class="size-12" style="Margin-top: 0;Margin-bottom: 20px;font-size: 12px;line-height: 19px;text-align: center;" lang="x-size-12"><span style="color:#14106e"><em>Designed By <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #80bf2e;" href="https://www.vibtechghana.com">VibTech Ghana</a>&nbsp;&copy; {{\Carbon\Carbon::today()->format('Y')}}</em></span></p>
      </div>
    </div>
