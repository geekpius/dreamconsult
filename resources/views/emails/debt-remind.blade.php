...
<!DOCTYPE html><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!--><html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
  ...
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
      ...
      <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
        <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;display: block;height: auto;width: 100%;max-width: 46px;" alt="" width="46" src="{{ asset('assets/images/logos/main-logo.png') }}" />
      </div>
    
          <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;Margin-bottom: 24px;">
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      <h1 class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 17px;line-height: 26px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-20"><span style="color:#f0670c"><strong>DEBT REMINDER</strong></span></h1><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">Hi {{ ucfirst($data['first_name']) }},</p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">You are being reminded that you are owning a total sum of <span style="color:#f50a25"><strong>GH&#x20B5; {{ number_format($data['debt'],2) }}</strong></span>. Below are the summary of your debts details.</p>
         
        <hr>   
      <table>
        <tr>
          <td width="60px"><p class="size-12" style="Margin-top: 20px;Margin-bottom: 0;font-size: 12px;line-height: 21px;" lang="x-size-12"><strong>SERVICE</strong></p></td>
          <td width="60px"><p class="size-12" style="Margin-top: 20px;Margin-bottom: 0;font-size: 12px;line-height: 21px;" lang="x-size-12"><strong>PAYABLE</strong></p></td>
          <td width="60px"><p class="size-12" style="Margin-top: 20px;Margin-bottom: 0;font-size: 12px;line-height: 21px;;" lang="x-size-12"><strong>PAID</strong></p></td>
          <td><p class="size-12" style="Margin-top: 20px;Margin-bottom: 0;font-size: 12px;line-height: 21px;" lang="x-size-12"><strong>BALANCE</strong></p></td>
        </tr>
        @php $total_payable = 0; $total_paid = 0; $total_balance = 0; @endphp
        @foreach ($data['services'] as $item)
        @php $total_payable += $item->payable; $total_paid += $item->paid; $total_balance += ($item->payable-$item->paid); @endphp
        <tr style="font-size:11px !important">
          <td>{{ $item->type }}</td>
          <td><small>GH&#x20B5;</small> {{ number_format($item->payable,2) }}</td>
          <td><small>GH&#x20B5;</small> {{ number_format($item->paid,2) }}</td>
          <td><small>GH&#x20B5;</small> {{ number_format(($item->payable-$item->paid),2) }}</td>
        </tr>
        @endforeach


        <tr style="font-size:11px !important;color:#f50a25;">
          <td><strong>TOTAL</strong></td>
          <td><small>GH&#x20B5;</small> {{ number_format($total_payable,2) }}</td>
          <td><small>GH&#x20B5;</small> {{ number_format($total_paid,2) }}</td>
          <td><small>GH&#x20B5;</small> {{ number_format($total_balance,2) }}</td>
        </tr>
      </table>

      <hr>
      <p style="Margin-top: 20px;Margin-bottom: 0;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #41637e;" href="https://dreamsconsult.com/">Dreams&nbsp;Consult</a>,&nbsp;We&nbsp;make&nbsp;it&nbsp;Happen.</p>
    </div>
  </div>
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
          <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              ...
              <td style="padding: 0;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://www.facebook.com/dreamsconsult"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/beta/13-the-blueprint-3/images/facebook.png" width="26" height="26" alt="Facebook" /></a></td>
              </tr></tbody></table>
              <div style="font-size: 12px;line-height: 19px;Margin-top: 20px;">
                <div>ACCRA: Achimota New Station Overhead, Accra.<br />
KUMASI: Dovewell Building Opposite STC Terminal, Adum Kumasi.</div>
              </div>
          ...
          <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;">
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              <div style="font-size: 12px;line-height: 19px;">
                <p style="text-decoration: underline;">Designed By <a href="https://www.vibtechghana.com">VibTech Ghana</a> &copy; {{\Carbon\Carbon::today()->format('Y')}}</p>
              </div>
            </div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
