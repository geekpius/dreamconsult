...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      <h1 class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 17px;line-height: 26px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-20"><span style="color:#f0670c"><strong>RECEIPT</strong></span></h1><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">Hi {{ ucfirst($data['first_name']) }},</p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">This is your payment receipt.</p><p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;text-align: left;" lang="x-size-14"><strong><span style="color:#080008">Official Receipt No#: {{ $data['payment']->receipt_no }}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span></strong><span style="color:#080008">Issued&nbsp;Date: {{ \Carbon\Carbon::parse($data['payment']->created_at)->format('d-M-Y') }}</span></p>
      <p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height:21px;text-align: left;" lang="x-size-14">A sum of&nbsp; <span> {{ $data['words'] }} Ghana cedis {{ $data['payment']->mode }}</p>
      <p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height:21px;text-align: left;" lang="x-size-14">Being&nbsp;&nbsp;{{ ($data['payment']->owe<=0)? 'Balance payment':'Part payment' }} for {{ $data['payment']->service }}</p>
      @if($data['discount']>0)
      <p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height:21px;text-align: left;" lang="x-size-14">You paid GH&#x20B5; {{ number_format(($data['payment']->paid-$data['discount']),2) }} and got a discount of GH&#x20B5; {{ number_format($data['discount'],2) }}</p>
      @endif
      <p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;text-align: left;" lang="x-size-14">Balance GH&#x20B5; {{ number_format($data['payment']->owe,2) }}</p><p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;text-align: left;" lang="x-size-14"><strong>Paid GH&#x20B5; {{ number_format($data['payment']->paid,2) }}</strong></p><p style="Margin-top: 20px;Margin-bottom: 0;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #41637e;" href="https://dreamsconsult.com/">Dreams&nbsp;Consult</a>,&nbsp;We&nbsp;make&nbsp;it&nbsp;Happen.</p>
    </div>
  </div>
