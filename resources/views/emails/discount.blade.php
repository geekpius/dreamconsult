...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      <h1 class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 17px;line-height: 26px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-20"><span style="color:#f0670c"><strong>DISCOUNT GIVEOUT</strong></span></h1><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">Hi {{ ucfirst($data['first_name']) }},</p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">You have been given discount for a total sum of <span style="color:#f50a25"><strong>GH&#x20B5; {{ number_format($data['discount'],2) }}</strong></span>. It was discounted on your {{ $data['for'] }} service.</p>
